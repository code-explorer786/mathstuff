...
\title{\textbf{Favorites} \\ \normalsize A compilation of problems --- Definitely a draft}
...
There I found\footnote{...A year ago. Nowadays (in my opinion) it's kinda dead, but at least the bot works.}, along with wonderful people, the amazing volunteer-based \emph{Problem Of The Day} system held up by the server's internal bot \texttt{MODSBot}. It presented to me a myriad of problems\footnote{As of writing, \textbf{2534} problems and counting!} sourced from competitions, big and small, niche and popular; with problems easy and hard, gross and beautiful, long and short, all in the 4 flavours \emph{Algebra}, \emph{Combinatorics}, \emph{Geometry}, and \emph{Number Theory}. There I grinded, together and alone, 'till as of writing I marked \textbf{216} problems as \emph{solved}!

And now, after a year, I'm here, typing this document, eager to share it all. The purpose of this document is so that I can show off all of the \textcolor{purple!80!black}{cool gems} I found over the year, ``favorite'' problems I find to be interesting (or rather instructive), or that I find simply funny.
...
\begin{problem}[Simon line gaming. Also from my homework]
    ...
    \begin{enumerate}[label=(\alph*)]
        ...
        \item Let \(\ell_D\) be the line \(D_A - D_B - D_C\), and define \(\ell_A\), \(\ell_B\), \(\ell_C\) similarly\footnote{I can see you trying to draw \(A_B\), \(A_C\), \(A_D\), \(B_A\), \(B_C\), \(B_D\), \(C_A\), \(C_B\), \(C_D\), \(D_A\), \(D_B\), \(D_C\)...}. Prove that \(\ell_A\), \(\ell_B\), \(\ell_C\), \(\ell_D\) concur at one point.
    \end{enumerate}
\end{problem}
