...
\begin{problem}[POTD 2533]
    For which integers \(m\) does an infinite string of characters
        \[S = c_1c_2c_3c_4c_5...\]
    exist such that for all \(n \in \mathbb{Z}_{> 0}\), there are exactly \(m\cdot n\) distinct substrings of \(S\) with length \(n\)?

    (A substring is a finite subsequence of consecutive characters.)
    \begin{talks}
        \begin{talk}
            Incredible problem! Took me \texttt{1:00:10:00} to solve it!
        \end{talk}
        \begin{talk}
            This problem got me in a \href{https://youtu.be/1-F1oCFPiIM?t=8298}{trance} about graphs and cycles for hours straight
        \end{talk}
        \begin{talk}
            The cycles consume.
        \end{talk}
